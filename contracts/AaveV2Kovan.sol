...
//
//
// NOTE: this is an exact copy of the core contract
// but with the lpAddressProvider address changed
//
//
...
import '@sherlock/v1-core/contracts/interfaces/aaveV2/ILendingPool.sol';
import '@sherlock/v1-core/contracts/interfaces/aaveV2/ILendingPoolAddressesProvider.sol';
import '@sherlock/v1-core/contracts/interfaces/aaveV2/IAaveIncentivesController.sol';
import '@sherlock/v1-core/contracts/interfaces/aaveV2/IStakeAave.sol';
import '@sherlock/v1-core/contracts/interfaces/aaveV2/IAToken.sol';

import '@sherlock/v1-core/contracts/interfaces/IStrategy.sol';

contract AaveV2Kovan is IStrategy {
